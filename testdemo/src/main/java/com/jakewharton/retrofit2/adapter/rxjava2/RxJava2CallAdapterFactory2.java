...
public final class RxJava2CallAdapterFactory2 extends CallAdapter.Factory {
  ...
  public static RxJava2CallAdapterFactory2 create() {
    return new RxJava2CallAdapterFactory2(null,null);
  }
  ...
  public static RxJava2CallAdapterFactory2 createWithScheduler(Scheduler schedulerSubscribeOn) {
    ...
    return new RxJava2CallAdapterFactory2(schedulerSubscribeOn,null);
  }
   ...
   * {@linkplain Observable#subscribeOn(Scheduler) subscribe on} {@code scheduler} by default.
   */
  public static RxJava2CallAdapterFactory2 createWithSchedulers(Scheduler schedulerSubscribeOn, Scheduler schedulerObserveOn) {
    ...
    return new RxJava2CallAdapterFactory2(schedulerSubscribeOn, schedulerObserveOn);
  }

  private final Scheduler schedulerSubscribeOn;
  private final Scheduler schedulerObserveOn;

  private RxJava2CallAdapterFactory2(Scheduler schedulerSubscribeOn, Scheduler schedulerObserveOn) {
  ...
  public CallAdapter<?,?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
    ...
    if (rawType == Completable.class) {
      ...
      return new RxJava2CallAdapter2(Void.class, schedulerSubscribeOn,schedulerObserveOn, false, true, false, false, false, true);
    }
    ...
    return new RxJava2CallAdapter2(responseType, schedulerSubscribeOn,schedulerObserveOn, isResult, isBody, isFlowable,
